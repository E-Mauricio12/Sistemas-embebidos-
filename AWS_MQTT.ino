...
//Añadir bibliotecas
#include "SPIFFS.h" //hacer sistemas de archivos en el esp32 sin necesidad d usar una sd externa
#include <WiFiClientSecure.h> //establecer conexión cifrada entre extermo y extremo, por wifi
#include <PubSubClient.h> //crear cliente MQTT
#include <Adafruit_BMP085.h>
#include <ArduinoJson.h> //para pasar jasons
